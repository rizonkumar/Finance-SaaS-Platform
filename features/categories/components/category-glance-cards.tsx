    ...
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
      <Card className="flex flex-col justify-between gap-y-2 p-4">
        <div className="flex items-start justify-between gap-x-2">
          <p className="label-13 text-gray-900">Total Categories</p>
          <div className={cn(iconBox({ variant: "default" }), "size-7")}>
            <Shapes className="size-3.5" />
          </div>
        </div>
        <p className="numeric heading-24 text-gray-1000">{totalCategories}</p>
      ...
      <Card className="flex flex-col justify-between gap-y-2 p-4">
        <div className="flex items-start justify-between gap-x-2">
          <p className="label-13 text-gray-900">Total Spending</p>
      ...
      <Card className="flex flex-col justify-between gap-y-2 p-4">
        <div className="flex items-start justify-between gap-x-2">
          <p className="label-13 text-gray-900">Top Category</p>
      ...
      <Card className="flex flex-col justify-between gap-y-2 p-4">
        <div className="flex items-start justify-between gap-x-2">
          <p className="label-13 text-gray-900">Budget Coverage</p>
